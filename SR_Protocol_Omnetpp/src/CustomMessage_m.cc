...
char CustomMessage_Base::getHeader() const
{
    return this->header;
}

void CustomMessage_Base::setHeader(char header)
{
    this->header = header;
}
...
char CustomMessage_Base::getTrailer() const
{
    return this->trailer;
}

void CustomMessage_Base::setTrailer(char trailer)
{
...
int CustomMessage_Base::getAckNackNumber() const
{
    return this->ackNackNumber;
}

void CustomMessage_Base::setAckNackNumber(int ackNackNumber)
{
...
int CustomMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='a' && strcmp(fieldName, "ackNackNumber")==0) return base+4;
...
std::string CustomMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return long2string(pp->getAckNackNumber());
        default: return "";
    }
}
...
bool CustomMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setAckNackNumber(string2long(value)); return true;
